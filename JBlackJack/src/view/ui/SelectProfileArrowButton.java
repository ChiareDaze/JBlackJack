...
/**
 * The SelectProfileArrowButton class represents an arrow button used in the profile selection UI.
 * It handles the button's state, appearance, and interactions.
 */
public class SelectProfileArrowButton {
    ...
    /**
     * Constructs a SelectProfileArrowButton object with the specified position, size, and row index.
     *
     ...
     */
    public SelectProfileArrowButton(int x, int y, int width, int height, int rowIndex){
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
